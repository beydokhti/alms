	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
            ...
            <div class="row">
				...
				<li class="fieldcontain">
					<span id="degree-label" class="property-label"><g:message code="person.degree.label" default="Degree" /></span>
					
						<span class="property-value" aria-labelledby="degree-label"><g:fieldValue bean="${personInstance}" field="degree"/></span>
				...
				<li class="fieldcontain">
					<span id="field-label" class="property-label"><g:message code="person.field.label" default="Field" /></span>
					
						<span class="property-value" aria-labelledby="field-label"><g:fieldValue bean="${personInstance}" field="field"/></span>
				...
				<li class="fieldcontain">
					<span id="dataOfBirth-label" class="property-label"><g:message code="person.dataOfBirth.label" default="Data Of Birth" /></span>
					
						<span class="property-value" aria-labelledby="dataOfBirth-label"><g:formatDate date="${personInstance?.dataOfBirth}" /></span>
				...
				<li class="fieldcontain">
					<span id="nationalCode-label" class="property-label"><g:message code="person.nationalCode.label" default="National Code" /></span>
					
						<span class="property-value" aria-labelledby="nationalCode-label"><g:fieldValue bean="${personInstance}" field="nationalCode"/></span>
				...
				<li class="fieldcontain">
					<span id="certificates-label" class="property-label"><g:message code="person.certificates.label" default="Certificates" /></span>
