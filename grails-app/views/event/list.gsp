...
//                },
        ...
        <legend><g:message code="broker.list" default="Events List"></g:message></legend>
        ...
        <div class="well">
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered full-width"
                ...
                <tr>
                    ...
                    <th><g:message code="exam.examDate" default="examDate"/></th>

                    <th><g:message code="exam.examStartTime" default="examStartTime"/></th>

                    <th><g:message code="exam.examEndTime" default="examEndTime"/></th>

                    <th><g:message code="exam.location" default="location"/></th>
