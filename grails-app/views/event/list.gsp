			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="startTimezone" title="${message(code: 'event.startTimezone.label', default: 'Start Timezone')}" />
					
						<g:sortableColumn property="endTimezone" title="${message(code: 'event.endTimezone.label', default: 'End Timezone')}" />
				...
				<g:each in="${eventInstanceList}" status="i" var="eventInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: eventInstance, field: "startTimezone")}</td>
					
						<td>${fieldValue(bean: eventInstance, field: "endTimezone")}</td>
