		...
		<div id="show-certificate" class="content scaffold-show" role="main">
			...
			<ol class="property-list certificate">
				...
				<li class="fieldcontain">
					<span id="cerType-label" class="property-label"><g:message code="certificate.cerType.label" default="Cre Type" /></span>
					
						<span class="property-value" aria-labelledby="cerType-label"><g:fieldValue bean="${certificateInstance}" field="cerType"/></span>
				...
				<li class="fieldcontain">
					<span id="cerTitle-label" class="property-label"><g:message code="certificate.cerTitle.label" default="Cer Title" /></span>
					
						<span class="property-value" aria-labelledby="cerTitle-label"><g:fieldValue bean="${certificateInstance}" field="cerTitle"/></span>
