...
<div class="fieldcontain ${hasErrors(bean: certificateInstance, field: 'cerType', 'error')} ">
	...
	<g:select name="cerType" from="${certificateInstance.constraints.cerType.inList}" value="${certificateInstance?.cerType}" valueMessagePrefix="certificate.cerType" noSelection="['': '']"/>
</div>
