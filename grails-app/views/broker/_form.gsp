...
<div class="form-group col-md-6">
    ...
    <div class="col-sm-8">
        <g:datePicker class="form-control" name="registerDate" precision="day" value="${brokerInstance?.registerDate}"
...
<div class="form-group col-md-6">
    ...
    <div class="col-sm-8">
        <g:datePicker class="form-control" name="seoRegisterDate" precision="day"
                      value="${brokerInstance?.seoRegisterDate}" default="none" noSelection="['': '']"/>
...
<div class="form-group col-md-6">
    ...
    <div class="col-sm-8">
        ...
        <g:datePicker class="form-control" name="clubMembershipDate" precision="day"
                      value="${brokerInstance?.clubMembershipDate}" default="none" noSelection="['': '']"/>
