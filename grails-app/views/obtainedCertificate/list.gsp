...
<body>
<a href="#list-obtainedCertificate" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-obtainedCertificate" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="obtainedDate"
                              title="${message(code: 'obtainedCertificate.obtainedDate.label', default: 'Obtained Date')}"/>
        ...
        <g:each in="${obtainedCertificateInstanceList}" status="i" var="obtainedCertificateInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${obtainedCertificateInstance.id}">${fieldValue(bean: obtainedCertificateInstance, field: "certificate")}</g:link></td>
