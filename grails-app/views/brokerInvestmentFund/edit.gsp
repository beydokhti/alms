...
<html>
	...
	<body>
		<a href="#edit-brokerInvestmentFund" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-brokerInvestmentFund" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${brokerInvestmentFundInstance?.version}" />
				<fieldset class="form">
