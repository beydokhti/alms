...
<html>
	...
	<body>
		<a href="#edit-brokerTradingStation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-brokerTradingStation" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${brokerTradingStationInstance?.version}" />
				<fieldset class="form">
